...
**Status:** NOT READY  
**Assessed commit:** `0f61ac4` (updated after final integration)  
...
| W-05 | P2 | Custom secret scanners remain heuristic | Expanded scans cannot detect every arbitrary binary/encoded secret; current available Dependabot alert list is not a universal assurance. | Maintainer should verify GitHub secret scanning and push protection settings for this public repository and conduct a synthetic non-secret detector test in an isolated test repository; do not seed real credentials here. |
...
- [ ] Complete supplier/legal approvals and run production preflight against the real evidence root.
...
- Archives are convenience JSONL copies. Use the approved manual or external records process, and preserve source transcripts until filing is verified.
